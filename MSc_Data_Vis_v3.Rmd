...
![](inst/tutorials/MSc_Data_Vis/images/plots_to_learn.png){width=70%}
...
![](inst/tutorials/MSc_Data_Vis/images/anscombe.png){width=70%}
...
![](inst/tutorials/MSc_Data_Vis/images/Penguins.png)
...
![](inst/tutorials/MSc_Data_Vis/images/EDA-boxplot.png)
...
ggplot(penguins, aes(x = bill_length_mm, y = flipper_length_mm)) +
  ...
  labs(x = "Bill Length (mm)", y = "Flipper Length (mm)",
       colour = "Bill Length (mm)", shape = "Bill Length (mm)",
       caption = "Slope = 1.69, Intercept = 126.68") +
  theme_bw() +
  theme(legend.position = "top")
